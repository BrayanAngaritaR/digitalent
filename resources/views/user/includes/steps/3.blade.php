	        	...
	        	<div class="row mt-5">
	        		...
	        		<div class="col-md-3 p-0 my-auto">
	        			<div class="card pt-3 pl-3 pb-3 pr-0 step z-index">
	        				<a href="{{ route('user.ideas.get.step2', $idea) }}" class="text-dark step-link">
	        					Paso 2
	        					<p class="m-0 text-dark">Diseña tu negocio</p>
	        				</a>
	        			</div>
	        		</div>
	        		...
	        		<div class="col-md-3 p-0 my-auto">
	        			<div class="card pt-3 pl-3 pb-3 pr-0 step step-active z-index">
	        				<a href="{{ route('user.ideas.get.step3', $idea) }}" class="text-white step-link">
	        					<h4>Paso 3</h4>
	        		...
	        		<div class="col-md-9">
	        			<div class="mt-5">
	        				<h5 class="bold raleway f-18">Promociona tu negocio</h5> 
	        			...
	        			<div class="mt-5 z-index raleway">
	        				...
	        				<p>Visita los siguientes enlaces para aprender más sobre cómo promocionar tu negocio</p>
	        			...
	        			<div class="mt-5 z-index raleway">
	        				...
	        				<form action="{{ route('user.ideas.save.step3', $idea) }}" method="POST">
	        					@csrf
