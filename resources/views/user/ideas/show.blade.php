	        	...
	        	<div class="row mt-5">
	        		<div class="col-md-3 p-0 my-auto">
	        			<div class="card pt-3 pl-3 pb-3 pr-0 step step-active z-index">
	        				...
	        				<span class="float-right">
	        					<a href="{{ route('user.ideas.show', $idea) }}" class="text-white step-link">
		        					<h4 class="m-0">Paso 1</h4>
	        		...
	        		<div class="col-md-9">
	        			...
	        			<div class="mt-5 z-index raleway">
	        				...
	        				<form action="{{ route('user.ideas.save.step1', $idea) }}" method="POST" id="taskForm">
	        					@csrf
		        				@forelse($tasks as $task)
			        				<div class="form-check">
		        						<input class="form-check-input number" 
		        							type="checkbox" 
		        							id="task{{$task->id}}" 
		        							value="{{ $task->id }}" 
		        							name="tasks[]" 
